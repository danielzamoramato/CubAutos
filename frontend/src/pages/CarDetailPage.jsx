    ...
    <div className="min-h-screen bg-slate-100">
      ...
      <div className="max-w-3xl mx-auto px-3 sm:px-4 py-5 sm:py-8">
        ...
        <div className="mb-5 sm:mb-8">
          <AdSlot placement="detail_sidebar" />
        </div>
        ...
        <div className="flex flex-col gap-5 sm:gap-8">
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="bg-white rounded-xl p-4 shadow-sm border border-slate-200 space-y-3">
              ...
              <Detail label="Combustible" value={car.is_electric ? 'Eléctrico' : 'Combustión'} />
            ...
            <div className="bg-white rounded-xl p-4 shadow-sm border border-slate-200">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                ...
                {car.owner_phone && (
                  <a href={`https://wa.me/${car.owner_phone.replace(/\D/g, '')}?text=${encodeURIComponent(`Hola, vi tu carro (${car.brand} ${car.model}) en D&D. Me interesa.`)}`}
