export default function Footer() {
  return (
    <footer className="bg-gradient-to-r from-slate-800 to-slate-700 mt-auto">
      <div className="max-w-7xl mx-auto px-4 py-8 sm:py-10 text-center">
        <p className="text-slate-300 text-sm sm:text-base mb-4">
          ¿Interesado en promocionar tu vehículo o negocio?<br className="hidden sm:block" />
          Escríbenos directamente.
        </p>
        <a 
          href="https://wa.me/5355215158"
          target="_blank"
